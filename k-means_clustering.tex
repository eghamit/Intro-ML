...
\begin{document}
	...
	\section{Iterations 2--4}
	Repeating assignment and update (full arithmetic omitted for brevity; each value
	is the mean of the assigned points):
	
	\noindent\textbf{Iteration 2}, centroids $(-3.375,-1),(2,2),(0,-3)$:
	\[
	C_1{=}\{9,11,12,14,16,17,18\}\!\Rightarrow\!\bigl(-\tfrac{25}{7},-\tfrac57\bigr){=}(-3.571,-0.714),\
	C_2{=}\{1{-}8,10\}\!\Rightarrow\!\bigl(\tfrac{19}{9},\tfrac53\bigr){=}(2.111,1.667),\
	C_3{=}\{13,15\}\!\Rightarrow\!(-2.5,-4).
	\]
	
	\noindent\textbf{Iteration 3}, centroids $(-3.571,-0.714),(2.111,1.667),(-2.5,-4)$:
	\[
	C_1{=}\{9,11,12,16\}\!\Rightarrow\!(-3,1.25),\quad
	C_2{=}\{1{-}8,10\}\!\Rightarrow\!(2.111,1.667),\quad
	C_3{=}\{13,14,15,17,18\}\!\Rightarrow\!(-3.6,-3.6).
	\]
	
	\noindent\textbf{Iteration 4}, centroids $(-3,1.25),(2.111,1.667),(-3.6,-3.6)$:
	\[
	C_1{=}\{7{-}12\}\!\Rightarrow\!\bigl(-2,\tfrac{19}{6}\bigr){=}(-2.0,3.167),\
	C_2{=}\{1{-}6\}\!\Rightarrow\!\bigl(\tfrac{23}{6},\tfrac12\bigr){=}(3.833,0.5),\
	C_3{=}\{13{-}18\}\!\Rightarrow\!\bigl(-\tfrac{11}{3},-\tfrac{10}{3}\bigr){=}(-3.667,-3.333).
	\]
