...
\section{Iteration 0 in Full Detail}
With $\theta_0=\theta_1=0$ every prediction is $0$, so the error of example $i$
is $e_i=0-y_i=-y_i$:
\begin{center}
\begin{tabular}{@{}cccc@{}}
\toprule
$x_i$ & $y_i$ & $e_i=\htheta(x_i)-y_i$ & $e_i x_i$\\
\midrule
1 & 1 & $-1$ & $-1$\\
2 & 3 & $-3$ & $-6$\\
3 & 2 & $-2$ & $-6$\\
...
5 & 4 & $-4$ & $-20$\\
\midrule
  & & $\sum e_i=-15$ & $\sum e_ix_i=-53$\\
\bottomrule
\end{tabular}
\end{center}
Hence the gradients and initial cost are
\[
g_0=\frac{-15}{5}=-3,\qquad
g_1=\frac{-53}{5}=-10.6,\qquad
J=\frac{1}{2\cdot5}\sum y_i^2=\frac{1+9+4+25+16}{10}=5.5 .
\]
The updated parameters are
\[
\theta_0\leftarrow 0-0.1(-3)=0.3,\qquad
\theta_1\leftarrow 0-0.1(-10.6)=1.06 .
\]

\section{Iteration Table}
Repeating the same computation gives the following trajectory (values rounded
to four decimals). The gradients $g_0,g_1$ and cost $J$ are evaluated
\emph{at the start} of each row, then the parameters are updated.
\begin{center}
\begin{tabular}{@{}rrrrrr@{}}
\toprule
Iter & $\theta_0$ & $\theta_1$ & $J(\bm\theta)$ & $g_0$ & $g_1$\\
\midrule
0 & $0.0000$ & $0.0000$ & $5.50000$ & $-3.0000$ & $-10.6000$\\
1 & $0.3000$ & $1.0600$ & $0.54280$ & $ 0.4800$ & $  1.9600$\\
2 & $0.2520$ & $0.8640$ & $0.37626$ & $-0.1560$ & $ -0.3400$\\
3 & $0.2676$ & $0.8980$ & $0.37034$ & $-0.0384$ & $  0.0808$\\
4 & $0.2714$ & $0.8899$ & $0.36981$ & $-0.0588$ & $  0.0034$\\
5 & $0.2773$ & $0.8896$ & $0.36948$ & $-0.0540$ & $  0.0173$\\
\bottomrule
\end{tabular}
\end{center}
